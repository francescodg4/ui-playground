...
/// The standard widgets in the Windows 8 Modern UI: flat and square, content as chrome. Groups are
/// set apart by large light titles only; buttons are 2px outlines that invert when pressed; fields,
/// lists and menus are white surfaces; LCD displays are accent live tiles; tabs are text headers.
...
public:
    ...
    void spinButton(QPainter& p, const QRect& rect, Qt::ArrowType type, const Look& look) const override;

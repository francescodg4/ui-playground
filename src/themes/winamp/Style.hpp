...
/// The standard widgets in the Winamp Modern skin: brushed-metal frames and capsule buttons,
/// fields and item views behind cobalt LCD glass with glowing text, LED indicators, VU-meter
/// progress, EQ-style slider thumbs and the skin's trapezoid tabs.

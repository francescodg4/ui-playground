...
/// The standard widgets in Liquid Glass: frosted cards over the ambient canvas, recessed glass
/// fields, clay buttons and knobs that compress when pressed, radiant glows for active states.

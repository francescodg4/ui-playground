...
#include "themes/glass/pages/BlueprintsPage.hpp"
#include "themes/glass/pages/EncyclopediaPage.hpp"
#include "themes/glass/pages/InventoryPage.hpp"
#include "themes/glass/pages/LogPage.hpp"
#include "themes/glass/pages/PhotoPage.hpp"
#include "themes/glass/pages/PingPage.hpp"
#include "themes/glass/widgets/ClayButton.hpp"
#include "themes/glass/widgets/Glass.hpp"
#include "themes/glass/widgets/PageTransition.hpp"
#include "themes/glass/widgets/TabBar.hpp"
    ...
    : PdaShell(parent)
{
    ...
    layout->setSpacing(8);
    auto* themeButton = new ClayButton(Icon::Palette);
    themeButton->setToolTip(tr("Select theme (Ctrl+T)"));
    connect(themeButton, &ClayButton::clicked, this, &PdaShell::selectThemeRequested);
    auto* top = new QHBoxLayout;
    top->addSpacing(themeButton->sizeHint().width());
    top->addWidget(m_tabs, 1);
    top->addWidget(themeButton, 0, Qt::AlignVCenter);
...
PdaWindow::~PdaWindow()
{
    if (Glass::Backdrop::instance().host() == this) {
        Glass::Backdrop::instance().setHost(nullptr);
    }
}
